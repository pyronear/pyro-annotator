/**
 * Core functionality tests for SequencesPagination component.
 * Focuses on pagination navigation, button states, and edge cases.
 */

import React from 'react';
import { render, screen, fireEvent } from '@testing-library/react';
import { SequencesPagination } from '@/components/sequences/SequencesPagination';
import type { PaginatedResponse, SequenceWithAnnotation } from '@/types/api';

describe('SequencesPagination', () => {
  ...
  describe('Display Tests', () => {
    it('should render pagination when there are multiple pages', () => {
      render(<SequencesPagination {...defaultProps} />);
    ...
    it('should render correct page information', () => {
      ...
      render(<SequencesPagination {...props} />);
    ...
    it('should not render when there is only one page', () => {
      ...
      const { container } = render(<SequencesPagination {...props} />);
  ...
  describe('Styling Tests', () => {
    it('should apply correct container classes', () => {
      const { container } = render(<SequencesPagination {...defaultProps} />);
  ...
  describe('Component Integration', () => {
    it('should work with different pagination configurations', () => {
      ...
      configurations.forEach(({ page, pages }) => {
        ...
        const { unmount } = render(<SequencesPagination {...props} />);
