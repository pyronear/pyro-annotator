/**
 * Core functionality tests for DetectionReviewTableHeader component.
 * Focuses on results display for detection review page, pagination controls, and filtering indicators.
 */

import React from 'react';
import { render, screen, fireEvent } from '@testing-library/react';
import { DetectionReviewTableHeader } from '@/components/sequences/DetectionReviewTableHeader';
...
describe('DetectionReviewTableHeader', () => {
  ...
  describe('Display Tests', () => {
    it('should render results count correctly with "fully annotated sequences" text', () => {
      render(<DetectionReviewTableHeader {...defaultProps} />);
      
      // Page 2, size 50, total 150: showing 51-100 of 150
      expect(screen.getByText('Showing 51 to 100 of 150 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should render results count for first page', () => {
      ...
      render(<DetectionReviewTableHeader {...props} />);
      
      expect(screen.getByText('Showing 1 to 25 of 100 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should render results count for last partial page', () => {
      ...
      expect(screen.getByText('Showing 151 to 175 of 175 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should show filtered count when model accuracy filter is applied', () => {
      ...
      expect(screen.getByText(/150 fully annotated sequences/)).toBeInTheDocument();
  ...
  describe('Props Tests', () => {
    ...
    it('should handle different model accuracy values', () => {
      ...
      modelAccuracyValues.forEach(accuracy => {
        ...
        const { unmount } = render(<DetectionReviewTableHeader {...props} />);
  ...
  describe('Edge Cases', () => {
    it('should handle zero results', () => {
      ...
      expect(screen.getByText('Showing 1 to 0 of 0 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should handle single result', () => {
      ...
      expect(screen.getByText('Showing 1 to 1 of 1 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should handle large numbers', () => {
      ...
      expect(screen.getByText('Showing 9901 to 9999 of 9999 fully annotated sequences')).toBeInTheDocument();
    ...
    it('should handle page calculation edge cases', () => {
      ...
      expect(screen.getByText('Showing 51 to 99 of 99 fully annotated sequences')).toBeInTheDocument();
    });
    ...
    it('should handle missing filter object properties', () => {
      ...
      expect(() => render(<DetectionReviewTableHeader {...props} />)).not.toThrow();
  ...
  describe('Styling Tests', () => {
    it('should apply correct CSS classes to container', () => {
      const { container } = render(<DetectionReviewTableHeader {...defaultProps} />);
    ...
    it('should apply correct text styling classes', () => {
      ...
      const resultsText = screen.getByText(/Showing \d+ to \d+ of \d+ fully annotated sequences/);
