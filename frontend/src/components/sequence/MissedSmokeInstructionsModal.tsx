          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
              ...
              <ul className="text-sm text-blue-700 space-y-2">
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-0.5">•</span>
                  <span>Look for smoke or fire outside the red boxes that may have been missed</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-0.5">•</span>
                  <span>Pay special attention to edges of the frame and partially visible smoke</span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-blue-500 mt-0.5">•</span>
                  <span>Consider atmospheric conditions that might obscure automatic detection</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-md p-4">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                <p><strong>Select "Yes"</strong> if you spot any smoke, fire, or suspicious activity that wasn't detected by the model.</p>
                <p><strong>Select "No"</strong> if the model appears to have detected all visible smoke and fire in the sequence.</p>
              </div>
            </div>
          </div>
        </div>
