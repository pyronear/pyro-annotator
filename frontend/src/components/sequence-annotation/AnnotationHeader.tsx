...
export const AnnotationHeader: React.FC<AnnotationHeaderProps> = ({
  ...
  return (
    <div
      className={`fixed top-0 left-0 md:left-64 right-0 backdrop-blur-sm shadow-sm z-30 ${headerBgClass}`}
    >
      <div className="px-10 py-3">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center space-x-3">
            <span className="text-xs text-gray-500">
              Press <kbd className="px-1 py-0.5 bg-gray-100 rounded text-xs font-mono">?</kbd> for
              shortcuts
            </span>
            {progress.isComplete ? (
