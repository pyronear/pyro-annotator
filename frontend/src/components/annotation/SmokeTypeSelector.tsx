...
export const SmokeTypeSelector: React.FC<SmokeTypeSelectorProps> = ({
  ...
  return (
    <div
      className={`flex items-center space-x-1 bg-white bg-opacity-10 backdrop-blur-sm rounded-md p-1 ${className}`}
    >
        ...
        return (
          <button
            ...
            className={`${sizeClass} font-medium rounded transition-colors ${
              isSelected ? colors.active : `${colors.inactive} text-white`
            }`}
