...
def cluster_boxes_by_iou(boxes_with_ids: List[Tuple[List[float], int]], iou_threshold: float) -> List[List[Tuple[List[float], int]]]:
    """
...
def merge_overlapping_boxes(boxes: List[List[float]], iou_threshold: float = 0.5) -> List[List[float]]:
    """
