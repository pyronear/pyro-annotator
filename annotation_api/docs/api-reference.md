    ...
    "sequences_bbox": [
        {
            ...
            "gif_url_main": "https://...",             # Optional: main GIF URL
            "gif_url_crop": "https://...",             # Optional: cropped GIF URL
...
```python
{
    ...
    "annotation": {
        "sequences_bbox": [
            {
                "is_smoke": True,
                "gif_url_main": "https://storage.example.com/main.gif",
                "gif_url_crop": "https://storage.example.com/crop.gif",
