...
class TestUserRetrieval:
    ...
    async def test_get_all_users(
        self, async_session: AsyncSession, test_user: User, regular_user: User
    ):
...
class TestUserAuthentication:
    ...
    async def test_authenticate_valid_credentials(self, async_session: AsyncSession):
        ...
        authenticated_user = await user_crud.authenticate(
            username=created_user.username, password=password
        )
...
class TestUserUpdates:
    ...
    async def test_update_user_basic_fields(
        self, async_session: AsyncSession, regular_user: User
    ):
